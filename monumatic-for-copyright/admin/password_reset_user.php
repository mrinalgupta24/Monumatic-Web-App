...
<body>
    <div class="login-page" style="background-image: url(assets/images/monument_collage.jpg);">
        <div class="login-from-wrap">
            <form class="login-from" action="user_authenticate_for_password_updation.php" method = "post">
                <h1 class="site-title">
                    <a href="#">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name= "updated_password" required class="validate">
                    <input type="hidden" class="validate" name="email" required value="<?php echo $_GET['email']; ?>">
                    <input type="hidden" class="validate" name="userid" required value="<?php echo $_GET['userid']; ?>">
