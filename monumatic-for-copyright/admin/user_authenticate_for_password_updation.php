...
try {
  ...
  // $mail->SMTPDebug=2; // Enable verbose debug output
    ...
    $mail->Subject='Account Password change OTP';
	$message = "<p>OTP For Monumatic Password change is : $otp </p>";

    $mail->Body="OTP For Monumatic Password change is : $otp ";
	// $mail->Body="maa";
    $mail->send();

 echo  "<script> alert('OTP For Monumatic Password change has been sent on registered mail id'); </script>";
} 
catch(Exception $e) {
...
<body>
    <div class="login-page" style="background-image: url(assets/images/monument_collage.jpg);">
        <div class="login-from-wrap">
            <form class="login-from" action="user_password_reset_mysql.php" method="post"  >
                <h1 class="site-title">
                    <a href="index.php">
                ...
                <div class="form-group">
                    <input type="submit" value="Verify OTP" class="validate">
                </div>
