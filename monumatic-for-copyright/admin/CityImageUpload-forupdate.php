...
if (isset($_POST['submit']) && isset($_FILES['my_image'])) {
	...
	if ($error === 0) {
		if ($img_size > 1250000) {
			...
			echo $citycountryname = $_POST['country'];


					$sql1 = "UPDATE `city_data` SET `Country`='$citycountryname',`city_status`='$citystatus', `imagepath`='admin/monument-upload/$new_img_name' WHERE city_name ='$cityname'";
					echo $cityname ;
