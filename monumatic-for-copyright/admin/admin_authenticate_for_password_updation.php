...
try {
 ...
 $email= $username;
    ...
    $mail->Subject='Account Password Reset OTP';
	$message = "<p>OTP For Monumatic Password Reset is : $otp </p>";

    $mail->Body="OTP For Monumatic Password Reset is : $otp ";
	// $mail->Body="maa";
    $mail->send();
...
<body>
    <div class="login-page" style="background-image: url(assets/images/monument_collage.jpg);">
        <div class="login-from-wrap">
            <form class="login-from" action="admin_password_reset_mysql.php" method="post"  >
                <h1 class="site-title">
                    <a href="index.php">
