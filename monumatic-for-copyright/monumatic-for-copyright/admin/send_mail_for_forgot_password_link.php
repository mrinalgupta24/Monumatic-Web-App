...
if ($stmt = $conn->prepare('SELECT `Serial_Number`, `User_Id`, `Username`, `Email` FROM Admin_User where Email = ? ORDER BY Serial_Number')) {
...
try {
   ...
   // $mail->SMTPDebug=2; // Enable verbose debug output
    ...
    $mail->Subject='Monumatic Account Chane Pasdword Link';
	$activate_link = 'http://localhost/Monumatic/admin/password_reset.php?email=' . $email . '&userid=' . $User_Id;
