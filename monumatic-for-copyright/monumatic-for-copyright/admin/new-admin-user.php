...
<body>
  ...
  <form class="form-horizontal" action="registeradmin.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>D.O.B</label>
                                            <input name="dateofbirth" required class="form-control" type="date">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Upload Govt ID</label>
                                             <input type="file" required name="my_image" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
