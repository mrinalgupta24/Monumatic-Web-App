  ...
  $emailforfetch = $_SESSION['email'];
    $user_id = $_SESSION['User_Id'];
       require 'connection.php';
        ...
        if ($sql = "UPDATE `Admin_User` SET `Verification_status`='In-Active',`Account_Status`='DELETED',`Comments`='ACCOUNT DELETED' WHERE Email='$emailforfetch' and User_Id ='$user_id'") {
            // Set the new activation code to 'activated', this is how we can check if the user has activated their account.
            require 'connection.php';
         $sql = "UPDATE `Admin_User` SET `Verification_status`='In-Active',`Account_Status`='DELETED',`Comments`='ACCOUNT DELETED' WHERE Email='$emailforfetch' and User_Id ='$user_id'";
