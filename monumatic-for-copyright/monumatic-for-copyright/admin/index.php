...
<body>
    <div class="login-page" style="background-image: url(assets/images/monument_collage.jpg);">
        <div class="login-from-wrap">
            <form class="login-from" action="admin_authenticate.php" method="post"  >
                <h1 class="site-title">
                    <a href="index.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name ="username" placeholder="Enter Your User Name" class="validate" required>
                </div>
                <div class="form-group">
                    <label for="last_name">Password</label>
                    <input id="last_name" name ="password" placeholder="Enter Your Password" type="password" class="validate" required>
                </div>
                <div class="form-group">
                    <input type="submit" value="Login" class="validate">
                </div>
                <a href="forgot-admin.php" class="for-pass">Forgot Password?</a>
                <a href="new-admin-user.php" class="for-pass">New User? Sign Up !!!!</a>
