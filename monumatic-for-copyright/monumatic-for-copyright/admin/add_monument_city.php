                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dashboard-box user-form-wrap">
                            <h4>Add City</h4>
                            <form class="form-horizontal" action="CityImageUpload.php" method="post" enctype="multipart/form-data" >
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>City Name</label>
                                            <input name="City_Name" required class="form-control" type="text">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
